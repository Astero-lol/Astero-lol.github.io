...
(() => {
    ...
    $icon.addEventListener('click', () => $icon.classList.toggle('header-nav__icon_active'))
})();
...
(function(root, factory) {
    ...
    function closeIcon() {
        return '<svg width="30" height="30" xmlns="http://www.w3.org/2000/svg"><g stroke="#2C313B" stroke-width="2" fill="none" fill-rule="evenodd"><path d="M1.083 1l27.384 27.384M28.467 1L1.083 28.384"/></g></svg>'
    }
